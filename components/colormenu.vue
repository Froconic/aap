  ...
  <div class="container">
    <div id="circularMenu" class="circular-menu">
      ...
      <menu class="items-wrapper">
        <a v-for="color in colors" :key="color" href="#" class="menu-item ">
...
<style>
  ...
  .circular-menu.active .menu-item:nth-child(1) {
    transform: translate3d(1.1em, -7.5em, 0);
  ...
  .circular-menu.active .menu-item:nth-child(3) {
    ...
    transform: translate3d(-3.3em, -6em, 0);
  }

  .circular-menu.active .menu-item:nth-child(4) {
    background-color: #2388FF;
    transform: translate3d(-5.5em, -4.6em, 0);
  }

  .circular-menu.active .menu-item:nth-child(5) {
    background-color: #2388FF;
    transform: translate3d(-7em, -2.5em, 0);
  }


  .circular-menu.active .menu-item:nth-child(6) {
    background-color: #24FF85;
    transform: translate3d(-7.5em, -.2em, 0);
  }
